...
;layui.define(["laytpl", "laypage", "layer", "form", "util"], function (e) {
    ...
    M.prototype.config = {
        ...
        if(this_info.limit==0){
            saveSessionStorage(a);
        }
        a.limit=this_info.limit==0?a.limit:this_info.limit;
    ...
    }, M.prototype.page = JSON.parse(sessionStorage.getItem(window.location.pathname)).page||1, M.prototype.pullData = function (e) {
        ...
        if (i.startTime = (new Date).getTime(), a.url) {
            var d = {};
            var this_info = JSON.parse(sessionStorage.getItem(window.location.pathname));
            d[l.pageName] = this_info.page||e, d[l.limitName] = this_info.limit||a.limit;
            if(!isNotEmpty(this_info)||this_info.cond==undefined||this_info.cond=={}||this_info.cond.search_param==undefined){var r = t.extend(d, a.where);}else{var r = t.extend(d, this_info.cond);}
            a.contentType && 0 == a.contentType.indexOf("application/json") && (r = JSON.stringify(r)), t.ajax({
                ...
                success: function (t) {
                    ...
                    fnPageCondLoad();
                    setTimeout(function () {form.render(); }, 1000);
                },
                error: function (e, t) {
                    if(t=='error'){
        ...
        var c = this,co=this, s = c.config, u = e[s.response.dataName] || [], f = [], p = [], v = [], m = function () {
            var e;
                ...
                0 !== l.length && (d || (l[r.config.indexName] = a), c.eachCols(function (n, d) {
                    ...
                    if (void 0 !== f && null !== f || (f = ""), !(d.colspan > 1 || d.hide)) {
                        var p = ['<td data-field="' + c + '" ' + function () {
                            ...
                            switch (d.type) {
                                case"checkbox":
                                    return '<input data-id="'+l[s.dataId]+'" type="checkbox" name="layTableCheckbox" lay-skin="primary" ' + function () {
                                        return d[o] ? (l[o] = d[o], d[o] ? "checked" : "") : n[o] ? "checked" : ""
                                    }() + function(){
                                        var index = (t.extend(!0, {LAY_INDEX: y}, l))[r.config.indexName];
                                        co.setCheckData(index,JSON.parse(sessionStorage.getItem(window.location.pathname)).checked.hasValue(l[s.dataId]));
                                        return JSON.parse(sessionStorage.getItem(window.location.pathname)).checked.hasValue(l[s.dataId])?"checked":""
                                    }()+">";
                                case"radio":
                                    return n[o] && (e = a), '<input data-id="'+l[s.dataId]+'" type="radio" name="layTableRadio_' + s.index + '" ' + (n[o] ? "checked" : "") +function(){
                                        var index = (t.extend(!0, {LAY_INDEX: y}, l))[r.config.indexName];
                                        co.setCheckData(index,JSON.parse(sessionStorage.getItem(window.location.pathname)).checked.hasValue(l[s.dataId]));
                                        return JSON.parse(sessionStorage.getItem(window.location.pathname)).checked.hasValue(l[s.dataId])?"checked":""
        ...
        if(isNotEmpty(l[e])&&isNotEmpty(a.dataId)){saveCheckedSessionStorage(l[e][a.dataId],t);}
