            ...
            var l = n.children && n.children.length > 0,
                ...
                s = o(["<li " + (n.spread ? 'data-spread="' + n.spread + '"' : "") + ">", function () {
                    ...
                    return r.check ? '<i class="layui-icon layui-tree-check">' + ("checkbox" === r.check ? t.checkbox[0] : "radio" === r.check ? t.radio[0] : "") + "</i>" : ""
                        ...
                        return (l ? ('<a href="' + (n.href || "javascript:;") + '" ' + (r.target && n.href ? 'target="' + r.target + '"' : "") + ">" + ('<i class="layui-icon layui-tree-' + (l ? "branch" : "leaf") + '">' + (l ? n.spread ? t.branch[1] : t.branch[0] : t.leaf) + "</i>") + ("<cite>" + (n.name || "未命名") + "</cite></a>")) :
                                ('<a href="' + (n.href || "javascript:;") + '" ' + (r.target && n.href ? 'target="' + r.target + '"' : "") + ">" + ('<i class="layui-icon layui-tree-' + (l ? "branch" : "leaf") + '">' + (l ? n.spread ? t.branch[1] : t.branch[0] : t.leaf) + "</i>") + ("<cite>" + (n.name || "未命名") + "</cite></a>" +
                                    '<a class="tree_btn tree_edit"><i class="layui-icon">&#xe642;</i></a><a class="tree_btn tree_delete"><i class="layui-icon">&#xe640;</i></a>')
                                 ))
                }(), "</li>"].join(""));
            l && (s.append(c), i.tree(c, n.children)), e.append(s), "function" == typeof r.click && i.click(s, n), i.spread(s, n), r.drag && i.drag(s, n),i.editClick(s,n),i.deleteClick(s,n)
        })
    }, r.prototype.editClick = function (e, o) {
        var a = this, i = a.options;
        e.children("a.tree_edit").on("click", function (e) {
            layui.stope(e), i.editClick(o)
        })
    }, r.prototype.deleteClick = function (e, o) {
        var a = this, i = a.options;
        e.children("a.tree_delete").on("click", function (e) {
            layui.stope(e), i.deleteClick(o)
        })
