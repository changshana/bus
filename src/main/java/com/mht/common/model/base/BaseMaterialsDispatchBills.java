...
/**
 * materials_dispatch_bills:( do not modify this file.)
 */
@SuppressWarnings({"serial", "unchecked"})
public abstract class BaseMaterialsDispatchBills<M extends BaseMaterialsDispatchBills<M>> extends Model<M> implements IBean {
	...
	*设置名称 
	*/
	public M setDispatchBillsName(java.lang.String dispatchBillsName) {
		set("dispatch_bills_name", dispatchBillsName);
		return (M)this;
	}
	...
	*获取名称 
	*/
	public java.lang.String getDispatchBillsName() {
		return getStr("dispatch_bills_name");
	}

	/**
	*设置代码 
	*/
	public M setDispatchBillsCode(java.lang.String dispatchBillsCode) {
		set("dispatch_bills_code", dispatchBillsCode);
		return (M)this;
	}
	...
	*获取代码 
	*/
	public java.lang.String getDispatchBillsCode() {
		return getStr("dispatch_bills_code");
	}
