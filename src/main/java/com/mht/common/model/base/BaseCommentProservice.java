...
/**
 * comment_proservice:( do not modify this file.)
 */
@SuppressWarnings({"serial", "unchecked"})
public abstract class BaseCommentProservice<M extends BaseCommentProservice<M>> extends Model<M> implements IBean {
