...
/**
 * personnel_social_security:( do not modify this file.)
 */
@SuppressWarnings({"serial", "unchecked"})
public abstract class BasePersonnelSocialSecurity<M extends BasePersonnelSocialSecurity<M>> extends Model<M> implements IBean {
	...
	*设置备案表id 
	*/
	public M setEnterId(java.lang.Integer enterId) {
