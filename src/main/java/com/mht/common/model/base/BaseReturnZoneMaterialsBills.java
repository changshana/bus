...
/**
 * return_zone_materials_bills:( do not modify this file.)
 */
@SuppressWarnings({"serial", "unchecked"})
public abstract class BaseReturnZoneMaterialsBills<M extends BaseReturnZoneMaterialsBills<M>> extends Model<M> implements IBean {
	...
	*设置名称 
	*/
	public M setZoneMaterialsBillsName(java.lang.String zoneMaterialsBillsName) {
		set("zone_materials_bills_name", zoneMaterialsBillsName);
		return (M)this;
	}
	...
	*获取名称 
	*/
	public java.lang.String getZoneMaterialsBillsName() {
		return getStr("zone_materials_bills_name");
	}

	/**
	*设置代码 
	*/
	public M setZoneMaterialsBillsCode(java.lang.String zoneMaterialsBillsCode) {
		set("zone_materials_bills_code", zoneMaterialsBillsCode);
		return (M)this;
	}
	...
	*获取代码 
	*/
	public java.lang.String getZoneMaterialsBillsCode() {
		return getStr("zone_materials_bills_code");
	}
