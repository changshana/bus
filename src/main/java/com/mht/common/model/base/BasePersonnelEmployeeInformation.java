...
/**
 * personnel_employee_information:( do not modify this file.)
 */
@SuppressWarnings({"serial", "unchecked"})
public abstract class BasePersonnelEmployeeInformation<M extends BasePersonnelEmployeeInformation<M>> extends Model<M> implements IBean {
