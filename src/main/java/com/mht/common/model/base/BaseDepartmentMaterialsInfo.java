...
/**
 * department_materials_info:( do not modify this file.)
 */
@SuppressWarnings({"serial", "unchecked"})
public abstract class BaseDepartmentMaterialsInfo<M extends BaseDepartmentMaterialsInfo<M>> extends Model<M> implements IBean {
