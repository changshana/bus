...
/**
 * dormitory_check_out_temp:( do not modify this file.)
 */
@SuppressWarnings({"serial", "unchecked"})
public abstract class BaseDormitoryCheckOutTemp<M extends BaseDormitoryCheckOutTemp<M>> extends Model<M> implements IBean {
	...
	*设置学生id 
	*/
	public M setTempStudentId(java.lang.Integer tempStudentId) {
		set("temp_student_id", tempStudentId);
		return (M)this;
	}
	...
	*获取学生id 
	*/
	public java.lang.Integer getTempStudentId() {
		return getInt("temp_student_id");
	}
