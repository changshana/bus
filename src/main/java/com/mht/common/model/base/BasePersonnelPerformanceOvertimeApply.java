...
/**
 * personnel_performance_overtime_apply:( do not modify this file.)
 */
@SuppressWarnings({"serial", "unchecked"})
public abstract class BasePersonnelPerformanceOvertimeApply<M extends BasePersonnelPerformanceOvertimeApply<M>> extends Model<M> implements IBean {
