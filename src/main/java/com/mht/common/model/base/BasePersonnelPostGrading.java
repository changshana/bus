...
/**
 * personnel_post_grading:( do not modify this file.)
 */
@SuppressWarnings({"serial", "unchecked"})
public abstract class BasePersonnelPostGrading<M extends BasePersonnelPostGrading<M>> extends Model<M> implements IBean {
