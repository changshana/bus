...
/**
 * department_materials_out_stock_bills:( do not modify this file.)
 */
@SuppressWarnings({"serial", "unchecked"})
public abstract class BaseDepartmentMaterialsOutStockBills<M extends BaseDepartmentMaterialsOutStockBills<M>> extends Model<M> implements IBean {
