...
/**
 * enroll_primary_school:( do not modify this file.)
 */
@SuppressWarnings({"serial", "unchecked"})
public abstract class BaseEnrollPrimarySchool<M extends BaseEnrollPrimarySchool<M>> extends Model<M> implements IBean {
	...
	*设置ID 
	*/
	public M setPrimarySchoolId(java.lang.Integer primarySchoolId) {
		set("primary_school_id", primarySchoolId);
		return (M)this;
	}
	...
	*获取ID 
	*/
	public java.lang.Integer getPrimarySchoolId() {
		return getInt("primary_school_id");
	}
	...
	*设置代码 
	*/
	public M setPrimarySchoolCode(java.lang.String primarySchoolCode) {
		set("primary_school_code", primarySchoolCode);
		return (M)this;
	}
	...
	*获取代码 
	*/
	public java.lang.String getPrimarySchoolCode() {
		return getStr("primary_school_code");
	}
