...
import com.mht.bus.util.wxPay.PayUtil;
import com.mht.bus.util.wxPay.UUIDHexGenerator;
import com.mht.bus.util.wxPay.XmlUtil;
import com.mht.common.CommonController;
import com.mht.common.model.dto.PaymentDto;
 ...
 * Description： TODO
 * Author: 作者
 * Date: Created in 2020/10/28 14:03
 * Company: 公司
 * Copyright: Copyright (c) 2017
 * Version: 0.0.1
 * Modified By:
 */
public class WeiXinPaymentController extends CommonController {
...
//    @ResponseBody
    public JSONObject payment() throws UnsupportedEncodingException, DocumentException {
        Kv cond = getCond(getParaMap());
        String openId = cond.getStr("openId");
        String total_fee = cond.getStr("total_fee");
        String body = cond.getStr("body");
        String attach = cond.getStr("attach");
