...
LEFT JOIN  (SELECT * FROM bus_aa99 WHERE aaa002 = 'aca036') ba1 ON bo.aca036 = ba1.aaa004
LEFT JOIN  (SELECT * FROM bus_aa99 WHERE aaa002 = 'aca035') ba2 ON bo.aca036 = ba2.aaa004
#if(aca035)
