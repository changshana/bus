        ...
        y = "layui-nav-more", h = "layui-anim layui-anim-upbit", f = {
            tabClick: function (t, i, s, o) {
                ...
                var n = i || a(this).parent(), s = n.index(), o = n.parents(".layui-tab").eq(0),
                    r1 = o.children(".layui-tab-content").children(".layui-tab-item"),
                    r2 = o.parents('.layadmin-pagetabs').eq(0).siblings('.layui-body').find('.layadmin-tabsbody-item'), c = o.attr("lay-filter");
                clearSessionStorage(n.attr('lay-attr'),"this");
                n.hasClass(l) && (n.next()[0] ? f.tabClick.call(n.next()[0], null, s + 1) : n.prev()[0] && f.tabClick.call(n.prev()[0], null, s - 1)), n.remove(), r1.eq(s).remove(),r2.eq(s).remove(), setTimeout(function () {
                    f.tabAuto()
