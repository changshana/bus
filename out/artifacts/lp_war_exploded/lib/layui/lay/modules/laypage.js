    ...
    u.prototype.type = function () {
        ...
        var n = a.pages > t ? Math.ceil((a.curr + (t > 1 ? 1 : 0)) / (t > 0 ? t : 1)) : 1, i = {
            prev: function () {
                ...
                }),e.join("") + "</select>"+"</span>"+'<span style="float:right"><select lay-ignore><option value="">——导出表格——</option><option value="0">导出当前页数据</option><option value="1">导出表格所有数据</option></select></span>'
*/
                var e = ['<span class="layui-laypage-limits">','<input type="number" min="1" class="layui-input page-input" value="'+a.limit+'" lay-ignore>条/页'];
                return e.join("") +"</span>"+'<span style="float:right"><select lay-ignore><option value="">——导出表格——</option><option value="0">导出当前页数据</option><option value="1">导出表格所有数据</option></select></span>'
        ...
        if (e) {
            ...
            var t = this, i = t.config, r = e.children, u = e[n]("button")[0], l = e[n]("input")[0],
                p = e[n]("input")[1],exp=e[n]("select")[0], c = function () {
                    var e = 0 | l.value.replace(/\s|\D/g, "");
            ...
            exp && s.on(exp, "change", function () {
                if(!isNotEmpty(this.value)){
                    ...
                    if(isNotEmpty(document.forms['cond-form'])){
                        $('form[name="cond-form"] input[type="hidden"]').each(function(i,o){
