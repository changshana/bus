...
;layui.define(["laytpl", "laypage", "layer", "form"], function (e) {
    ...
    S.prototype.config = {
        ...
        if (a.elem = t(a.elem), a.where = a.where || {}, a.id = a.id || a.elem.attr("id"), a.request = t.extend({
            ...
            "object" == typeof a.page && (a.limit = a.page.limit || a.limit, a.limits = a.page.limits || a.limits, e.page = a.page.curr = a.page.curr || 1, delete a.page.elem, delete a.page.jump), !a.elem[0]) return e;
        e.setArea();
    ...
    }, S.prototype.page = JSON.parse(sessionStorage.getItem(window.location.pathname)).page, S.prototype.pullData = function (e, i) {
        ...
        if (a.startTime = (new Date).getTime(), n.url) {
            var c = {};
            var this_info = JSON.parse(sessionStorage.getItem(window.location.pathname));
            c[o.pageName] = this_info.page, c[o.limitName] = this_info.limit, t.ajax({
                ...
                0 !== a.length && (r || (a[d.config.indexName] = e), c.eachCols(function (e, n) {
                    ...
                    if (void 0 !== f && null !== f || (f = ""), !(n.colspan > 1)) {
                        var y = ['<td data-field="' + r + '" ' + function () {
                            ...
                            return "checkbox" === n.type ? '<input data-id="'+a[s.dataId]+'" type="checkbox" name="layTableCheckbox" lay-skin="primary" ' + function () {
                                var t = d.config.checkName;
                                return n[t] ? (a[t] = n[t], n[t] ? "checked" : "") : e[t] ? "checked" : ""
                            }()+function(){
                                var index = (t.extend(!0, {LAY_INDEX: h}, a))[d.config.indexName];
                                c.setCheckData(index,JSON.parse(sessionStorage.getItem(window.location.pathname)).checked.hasValue(a[s.dataId]));
                                return JSON.parse(sessionStorage.getItem(window.location.pathname)).checked.hasValue(a[s.dataId])?"checked":""
