        ...
        s = "layui-this", o = "layui-hide", c = "layui-disabled", u = function () {
            this.config = {
                verify: {
                    ...
                    aphone: [/(^$)|(^0\d{2,3}-\d{7,8}$)|(^[1][3,4,5,7,8,9][0-9]{9}$)/, "请输入正确的电话号码"],
                    telphone: [/(^$)|(^0\d{2,3}-\d{7,8}$)/, "请输入正确的电话号码"],
                    phone: [/^[1][3,4,5,7,8,9][0-9]{9}$/, "请输入正确的手机号"],
                    xphone: [/(^$)|(^[1][3,4,5,7,8,9][0-9]{9}$)/, "请输入正确的手机号"],
    ...
    u.prototype.set = function (e) {
        ...
        var n = this, u = i(r + function () {
            ...
            select: function () {
                ...
                t.each(function (t, n) {
                    var ck=i(this).attr('contain-val');
                    if(isNotEmpty(i(this).val())&&isNotEmpty(ck)&&ck.indexOf(','+i(this).val()+',')!=-1){i(this).attr('checked','true');}
        ...
        $('[lay-verify="required"],[lay-verify="phone"],[lay-verify="email"],[lay-verify="date"],[lay-verify="identity"],[required]').parent('div').each(function(i,o){
            if($(o).siblings('.required_flag').length<1){
                $(o).before('<i class="required_flag">*</i>');
            }
        });
