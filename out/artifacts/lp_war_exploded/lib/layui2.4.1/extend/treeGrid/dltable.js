...
layui.define(['laytpl', 'laypage', 'layer', 'form'], function(exports){
            ...
            ,'<div class="layui-table-cell laytable-cell-'+ function(){ //返回对应的CSS类标识
                ...
                if(cols.type === 'checkbox'){
                    ...
                    return tplData[table.config.cols.radDisabled]?''
                        :'<input type="radio" name="'+TABLE_RADIO_ID+options.id+'" value="'+tplData[table.config.indexName]+'" checked="">';
                }
    ...
    Class.prototype.renderPage=function (count) {
        ...
        if(options.page){
            ...
            options.page.limit= options.page.limit||this_info.limit;
            options.page.curr= options.page.curr||this_info.curr;
            saveSessionStorage(options.page);
            options.page = $.extend({
...
//单元格编辑
    ...
    //自动完成渲染
    table.init();
    layui.link(Base.extendPath+'/treeGrid/treeGrid.css');
